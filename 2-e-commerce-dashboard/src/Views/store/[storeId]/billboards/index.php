    ...
    <section class="d-flex flex-column gap-4 container-fluid">
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="m-0">Billboards (<?= count($data["billboards"]) ?>)</h1>
                    <p class="text-body-secondary">Manage billboards for your store</p>
                </div>
                <div>
                    <a href="billboards/create" class="btn btn-dark-light">
                        + Add New
                    </a>
                </div>
            </div>
    ...
    <section class="d-flex flex-column gap-4 container-fluid">
        <div class="border">
            <table class="table m-0">
                <thead>
                    <tr>
                        <th class="col-w-60" scope="col">Label</th>
                ...
                <tbody>
                    <?php foreach ($data["billboards"] as $billboard) { ?>
                        <tr class="align-middle">
                            <td class="col-w-60"><?= $billboard["label"] ?></td>
                            <td><?= date('Y-m-d', strtotime($billboard["updatedAt"])) ?></td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="<?= BASE_URL ?>/store/<?= $data["store"]["id"] ?>/billboards/<?= $billboard["id"] ?>" class="dropdown-item d-flex gap-2" type="button">
                                                <span>
                                        ...
                                        <li>
                                            <button class="dropdown-item d-flex gap-2" type="button" data-bs-toggle="modal" data-bs-target="#<?= $billboard["id"] ?>">
                                                <span>
