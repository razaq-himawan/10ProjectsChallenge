        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article
                ...
                <a href="/posts/{{ $post->slug }}" class="hover:underline">
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white line-clamp-2">
                        {{ $post->title }}
                    </h2>
                </a>
                <p class="flex-grow mb-5 font-light text-gray-500 dark:text-gray-400">{{ Str::limit($post->body, 150) }}
                </p>
